...
[![shipthatcode — Build Your Own Shell](https://api.shipthatcode.com/cert/a2caf76ee7c521df3ae6be2182a31bc1.svg)](https://shipthatcode.com/courses/build-shell)
...
- a C compiler — `gcc` or `clang` (macOS: `xcode-select --install`, Ubuntu: `sudo apt install build-essential`, Windows: MinGW via Git Bash or WSL). Single-file, standard library only — no OpenSSL or other external libraries, same as the grader
